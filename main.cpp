...
int checkBrackets(char *file) //checks the file for stray or mismatched brackets using an array
{
    // create two stack array objects
    DSStack_array<char> brackets;
    DSStack_array<size_t> lineNumbers;
